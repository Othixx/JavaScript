...
上图中有一点需要注意，就是在右上角的宿主环境中，倒计时为0（也就是时间到）之后，会马上将`setTimeout`的回调函数添加到宏任务队列中，但并不是时间一到就立刻执行。如果调用栈里有东西没有执行完，它还是会接着执行调用栈里的代码，并不会去执行任何一个队列中的任务。
...
上题视频讲解：https://www.bilibili.com/video/BV1MN411y7pw?spm_id_from=333.788.videopod.episodes&vd_source=3f8c5c4e56e5c611151b798b557016c9&p=56
